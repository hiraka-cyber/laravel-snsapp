            ...
            <div class="card">
                <div class="card-haeder p-3 w-100 d-flex">
                    ...
                    <div class="ml-2 d-flex flex-column">
                        <a href="{{ url('users/' .$tweet->user->id) }}" class="text-secondary">{{ $tweet->user->name }}</a>
                    </div>
                ...
                <div class="card-body">
                <img src="{{ asset('storage/profile_image/' . $tweet->image) }}" alt="{{$tweet->image}}" width="100%" height="500px">
                    {!! nl2br(e($tweet->text)) !!}
                </div>
